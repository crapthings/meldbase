...
func runInit(args []string, stdout, stderr io.Writer) error {
	...
	fmt.Fprintln(stdout, "The bundle expects JWTs signed with secrets/jwt-hs256.secret and containing sub (actor ID), workspace_id (actor workspace ID), exp, iss, and aud.")
	return nil
}
