...
func runInit(args []string, stdout, stderr io.Writer) error {
	...
	config := singleNodeEnv(map[string]string{
		...
		"MELDBASE_WORKSPACE_COLLECTIONS": *workspaceCollections,
		"MELDBASE_WORKSPACE_FIELD":       *workspaceField,
	})
...
func singleNodeEnv(values map[string]string) string {
	keys := []string{
		...
		"MELDBASE_WORKSPACE_COLLECTIONS", "MELDBASE_WORKSPACE_FIELD",
	}
...
exec "${MELDBASE_BIN:-meld}" serve \
  ...
  --workspace-collections "$MELDBASE_WORKSPACE_COLLECTIONS" \
  --workspace-field "$MELDBASE_WORKSPACE_FIELD" \
