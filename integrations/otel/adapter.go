...
var intDescriptors = []intDescriptor{
	...
	{name: "meldbase.primary_write_fence.check", description: "V2 primary-write fence checks before logical primary commits.", unit: "{check}", kind: intCounter, read: func(s admin.Sample) (uint64, bool) { return available(s.Stats.PrimaryWriteFence.Checks) }},
	{name: "meldbase.primary_write_fence.rejection", description: "V2 primary-write fence checks that rejected a local write.", unit: "{rejection}", kind: intCounter, read: func(s admin.Sample) (uint64, bool) { return available(s.Stats.PrimaryWriteFence.Rejected) }},
	...
	{name: "meldbase.commit.coordinator.enabled", description: "Whether the optional V2 commit coordinator is enabled.", unit: "1", kind: intGauge, read: func(s admin.Sample) (uint64, bool) { return available(boolValue(s.Stats.CommitCoordinator.Enabled)) }},
	{name: "meldbase.commit.coordinator.pending", description: "Current requests waiting for V2 commit-coordinator admission.", unit: "{request}", kind: intGauge, read: func(s admin.Sample) (uint64, bool) { return available(s.Stats.CommitCoordinator.Pending) }},
	{name: "meldbase.commit.coordinator.pending_capacity", description: "Fixed V2 commit-coordinator pending-request capacity.", unit: "{request}", kind: intGauge, read: func(s admin.Sample) (uint64, bool) { return available(s.Stats.CommitCoordinator.PendingCapacity) }},
	{name: "meldbase.commit.coordinator.admitted", description: "Requests admitted by the V2 commit coordinator.", unit: "{request}", kind: intCounter, read: func(s admin.Sample) (uint64, bool) { return available(s.Stats.CommitCoordinator.Admitted) }},
	{name: "meldbase.commit.coordinator.admission_rejected", description: "Requests rejected because the V2 commit-coordinator queue was full.", unit: "{request}", kind: intCounter, read: func(s admin.Sample) (uint64, bool) { return available(s.Stats.CommitCoordinator.AdmissionRejected) }},
	...
	{name: "meldbase.commit.coordinator.grouped_transaction", description: "Logical requests processed in multi-member V2 commit-coordinator batches.", unit: "{request}", kind: intCounter, read: func(s admin.Sample) (uint64, bool) { return available(s.Stats.CommitCoordinator.GroupedTransactions) }},
