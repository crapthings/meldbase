...
func TestDatabaseRecoversCommitAfterQuorumResponsesAreLost(t *testing.T) {
	...
	db, err := meldbase.OpenV2WithOptions(path, meldbase.V2Options{RollbackProtection: meldbase.V2RollbackProtection{
	...
	reopened, err := meldbase.OpenV2WithOptions(path, meldbase.V2Options{RollbackProtection: meldbase.V2RollbackProtection{
...
func TestQuorumAnchorRejectsRolledBackDatabase(t *testing.T) {
	...
	db, err := meldbase.OpenV2WithOptions(path, meldbase.V2Options{RollbackProtection: meldbase.V2RollbackProtection{AnchorStore: store, InitializeAnchor: true, OperationTimeout: time.Second}})
	if err != nil {
		t.Fatal(err)
	}
	...
	opened, err := meldbase.OpenV2WithOptions(path, meldbase.V2Options{RollbackProtection: meldbase.V2RollbackProtection{AnchorStore: store, OperationTimeout: time.Second}})
