...
func TestMarshalPrometheusProducesCompleteLowCardinalityContract(t *testing.T) {
	...
	for _, expected := range []string{
		...
		`meldbase_query_keys_examined_total 34`,
		`meldbase_query_candidate_ids_total 31`,
		`meldbase_query_unique_candidate_ids_total 27`,
		`meldbase_query_duplicate_candidate_ids_total 4`,
		`meldbase_query_candidates_retained_total 12`,
		`meldbase_query_sort_bytes_total 2048`,
		`meldbase_query_early_stops_total 6`,
		`meldbase_query_budget_pressure_events_total 3`,
		`meldbase_query_budget_rejections_total 2`,
	...
	return Sample{
		Stats: meldbase.DBStats{
			...
			Queries: meldbase.QueryStats{
				...
				KeysExamined: 34, CandidateIDs: 31, UniqueCandidateIDs: 27, DuplicateCandidateIDs: 4,
				CandidatesRetained: 12, SortBytes: 2048, EarlyStops: 6,
				BudgetPressureEvents: 3, BudgetRejections: 2,
			},
