...
| Native JS/TS and React clients | Complete | `sdk/typescript`, `sdk/react`, shared query/mutation corpora, immutable cross-language protocol-v1 frame/capability contract and React external-store test |
