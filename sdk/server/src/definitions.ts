...
import type { ReadPolicyDefinition, ReadPolicyHandler, ReadPolicyOptions, RPCDefinition, RPCHandler, TransactionalRPCHandler } from "./types.js";
...
function validatePolicyFields(value: "*" | readonly string[], paths: boolean): void {
  if (value === "*") return;
  if (!Array.isArray(value) || value.length > 256) throw new TypeError("Read-policy field declaration must be '*' or a bounded array");
