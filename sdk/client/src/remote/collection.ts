import type { CountResult, DeleteResult, Document, Filter, GroupCountResult, InputDocument, MutationResult, Update } from "../types.js";
...
export class RemoteLiveQuery<T extends Document> {
  ...
  constructor(private readonly client: MeldbaseClient, readonly collection: string, readonly spec: import("../types.js").QuerySpec, private readonly seekPagination = false) {}
